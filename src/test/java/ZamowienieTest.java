...
//        //when
//        Pozycja pozycja3 = new Pozycja("woda", 10, 1.4);
...
//        //when
//        assertEquals(Double.valueOf(pozycja.obliczWartosc() + pozycja2.obliczWartosc()), Double.valueOf(suma));
//
//    }
//
//    @Test
//    public void testWyswietlaniaZamowienia() {
//
//        //given
//        Zamowienie zamowienie5 = new Zamowienie();
...
public class ZamowienieTest {
    ...
    public void testSumyZRabatem() {
        ...
        Zamowienie zamowienie10 = new Zamowienie();
        Pozycja pozycja = new Pozycja("Chleb", 2, 8.5);
        Pozycja pozycja2 = new Pozycja("maslo", 4, 7.50);
        Pozycja pozycja3 = new Pozycja("kawa", 10, 9.50);
        zamowienie10.dodajPozycje(pozycja);
        zamowienie10.dodajPozycje(pozycja2);
        zamowienie10.dodajPozycje(pozycja3);

        //when

        double suma = zamowienie10.obliczWartoscZRabatem();
